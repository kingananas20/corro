...
Why doesn't this code compile? It helps to look at the lifetime bounds that are automatically added by the compiler. For more details see the documentation for [lifetime elision]( [](https://doc.rust-lang.org/reference/lifetime-elision.html).)
